...
<div class="container-fluid" class="border border-warning" style="background-color: #daf0ee" >
    ...
    <div class="row" >
        ...
        <div class="col-md-9">
            <form action="/vendor/save1" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                <h2><center>Create Vendor</center></h2>
                <hr><br><br>
                <div class="form-row">

                    <div class="col-md-4 mb-3">
                        <label for="validationCustom01">First name</label>
                        <input type="text" class="form-control" id="validationCustom01" name="fname" placeholder="First name" value="" required>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom04" name="phone" placeholder="Phone Number" required>
                        <div class="invalid-feedback">
                ...
                <button id="singlebutton" name="singlebutton" class="btn btn-primary"  data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"><a href="/vendor/view"></a>Create Vendor</button>
