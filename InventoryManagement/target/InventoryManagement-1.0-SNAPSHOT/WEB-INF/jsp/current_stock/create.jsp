...
<hr>
<div class="container-fluid" class="border border-warning" style="background-color:#FFFFCC">
    <center>
        <h2 style="color: blue;">Current Stock Report</h2>
        <hr>
    </center>
    <br>
    <div class="row" >
        ...
        <div class="col-md-8">
            ...
            <form action="/currentStock/create"  method="POST">
                <div class="row">
