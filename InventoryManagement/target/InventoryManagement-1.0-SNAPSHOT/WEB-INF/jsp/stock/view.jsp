...
<hr>
<div class="container-fluid" class="border border-warning" style="background-color: #F0FFFF;text-align: center;">
    <div class="row">
        <div class="col-md-2">
        </div>
        <div class="col-md-10">
            <center><br>
                <h2>Purchase And Sales Report</h2><hr><br>
            </center><br><br><br><br>
...
<!--                            <td>
                                <a href="/stock/edit/${p.id}">Edit</a>
                                <a href="/stock/delete/${p.id}">Delete</a>
                            </td>-->
                        </tr>
                    </c:forEach>
                </tbody>
